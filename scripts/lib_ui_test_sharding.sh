UI_TEST_CASES=(
  ...
  testAgentRunningScenarioHistoryOpenBindsLiveSummaryWithoutRetryBanner
  testAgentRunningScenarioDoesNotLeakIntoChatAfterLaunch
  testAgentRunningScenarioCanStartNewConversationAndReopenLiveRun
  testAgentCompletedVisibleSynthesisKeepsProcessDoneWhileAnswerSearches
  testHistoryScenarioAgentSelectorPersistsChangesWithinSession
  testSettingsScenarioAgentDefaultsPersistWithinSession
