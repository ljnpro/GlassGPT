# 4.7.0 Parity Baseline

This document records the `4.6.1` production baseline that `4.7.0` must preserve.

## Stable Baseline

- source branch: `codex/stable-4.7`
- baseline branch: `codex/stable-4.6`
- development branch: `codex/feature/4.7.0-*`
- baseline app version: `4.6.1 (20178)`
...
Run this checklist against `v4.6.1` and the current `4.7.0` candidate:
