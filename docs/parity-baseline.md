# 5.7.0 Product Baseline

This document records the `5.4.0` production baseline that the `5.7.0`
...
restorations required for `5.7.0`.

## Baseline References

- active release line: `codex/stable-5.7`
- frozen rollback branch: `stable-4.12`
- baseline app version: `5.4.0`
- candidate app version: `5.7.0`
...
## 5.7.0 Release-Quality Requirements
