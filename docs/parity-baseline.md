# 4.6.0 Parity Baseline

This document records the `4.5.0` production baseline that `4.6.0` must preserve.

## Stable Baseline

- source branch: `codex/stable-4.6`
- baseline branch: `codex/stable-4.5`
- development branch: `codex/feature/4.6.0-*`
- baseline app version: `4.5.0 (20176)`
...
Run this checklist against `v4.5.0` and the current `4.6.0` candidate:
