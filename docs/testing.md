...
`5.4.0` testing is release-oriented. The suite must verify the real iOS +
...
## Current Gaps Being Closed In 5.4.0
...
- the final audit must exist at `docs/audit-5.4.0.md`
- full CI must pass
