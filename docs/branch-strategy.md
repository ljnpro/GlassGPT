...
- `main`
  - promotion target after a `5.5.x` release is validated
...
- `codex/stable-5.5`
  ...
  - default base for `5.5.x` hardening and release-preparation work

## Active Release Work

- `feature/release-5.5-*`
  - local release-preparation or hardening branches that stack on `codex/stable-5.5`
- `codex/feature/release-5.5-*`
  - remote mirrors of `5.5` release-preparation branches when pushed to GitHub

## Short-Lived Branches

- `feature/<topic>`
  - branch from the active `5.5` release line unless a different release line is explicitly intended
...
- `5.5.x` release candidates should be prepared from `codex/stable-5.5` or a
  `feature/release-5.5-*` branch cut from it.
- Do not promote `main` until the `5.5` candidate has:
