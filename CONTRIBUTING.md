...
|-------------------------|--------------------------------|
| `main`                  | Latest release                 |
| `codex/stable-4.x`     | Active development branch      |
| `codex/feature/*`       | Feature branches               |

Create feature branches from `codex/stable-4.x`. Target your pull requests
...
1. **All CI gates pass.** The project enforces 21 gates covering build,
   architecture, maintainability, source-share, infra-safety, module-boundary,
...
- New code must meet or exceed **80% line coverage**.
