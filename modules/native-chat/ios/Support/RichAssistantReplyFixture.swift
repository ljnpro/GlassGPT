...
enum RichAssistantReplyFixture {
    static let userPrompt = "写个1000词抒情文章"

    static let conversationTitle = "Rich Markdown Sample"

    static let codeConversationTitle = "Rich Markdown Code Sample"
    ...
    static let assistantReplyWithCodeBlock = """
