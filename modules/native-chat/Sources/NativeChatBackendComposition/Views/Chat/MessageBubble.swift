...
struct MessageBubble: View {
    let message: BackendMessageSurface
    ...
    init(
        ...
        renderKey = RenderKey(
            ...
            toolCallDigest: activeToolCalls.map { "\($0.id):\($0.status.rawValue)" }.joined(separator: ","),
            citationCount: liveCitations.count,
            annotationCount: liveFilePathAnnotations.count,
