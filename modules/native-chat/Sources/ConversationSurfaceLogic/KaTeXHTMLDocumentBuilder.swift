...
/// Builds self-contained HTML documents for KaTeX rendering in embedded web views.
public enum KaTeXHTMLDocumentBuilder {
    /// Offline KaTeX asset payload used when bundled CSS and JavaScript are available.
    public struct OfflineAssets: Sendable {
        public let css: String?
        public let js: String?
        public let baseURL: URL?

        /// Creates an offline KaTeX asset payload for document generation.
        public init(css: String?, js: String?, baseURL: URL?) {
            self.css = css
            self.js = js
    ...
    public static func makeDocument(
        ...
        if let css = assets.css, let js = assets.js {
            return (
                offlineHTML(
                    css: css,
                    js: js,
