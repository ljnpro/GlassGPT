...
public enum JSONCoding {
    ...
    public static func encode<T: Encodable>(_ value: T) throws(OpenAIServiceError) -> Data {
        do {
    ...
    public static func decode<T: Decodable>(_ type: T.Type, from data: Data) throws(OpenAIServiceError) -> T {
        do {
