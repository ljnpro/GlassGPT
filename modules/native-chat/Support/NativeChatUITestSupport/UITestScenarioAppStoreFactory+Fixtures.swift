...
extension UITestScenarioAppStoreFactory {
    ...
    private static func makeRichAgentProcessSnapshot() -> AgentProcessSnapshot {
        AgentProcessSnapshot(
            activity: .synthesis,
            currentFocus: "Finalize the Beta 5.0 cutover review",
            leaderAcceptedFocus: "Finalize the Beta 5.0 cutover review",
    ...
    private static func makeAgentTrace() -> AgentTurnTrace {
        AgentTurnTrace(
            ...
            processSnapshot: AgentProcessSnapshot(
                activity: .completed,
                currentFocus: "Finalize the Beta 5.0 release candidate",
                leaderAcceptedFocus: "Finalize the Beta 5.0 release candidate",
