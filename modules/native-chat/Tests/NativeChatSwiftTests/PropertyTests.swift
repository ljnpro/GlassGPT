...
struct PropertyTests {
    ...
    @Test func jsonRoundTripForStreamEnvelopesPreservesEquality() throws {
    ...
    @Test func encodedEnvelopesAreValidJSON() throws {
        let encoder = JSONEncoder()
    ...
    @Test func emptyEnvelopeRoundTrips() throws {
        let encoder = JSONEncoder()
        let decoder = JSONDecoder()
    ...
    @Test func resolvedResponseReturnsEmbeddedResponse() {
    ...
    @Test func resolvedResponseSynthesizesFromTopLevelFields() {
    ...
    @Test func jsonCodingRoundTrip() throws {
        for _ in 0..<50 {
            let original = randomEnvelope()
            do {
